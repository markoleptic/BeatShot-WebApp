    ...
    <>
      <div className="form-container">
        ...
        <p className="fs-100 text-lightgrey">
          Automatically save your scores in the cloud and gain access to visual analysis of every aspect of your play.
        </p>
        ...
        <form className="form" onSubmit={handleRegister}>
          <p className="fs-100 text-light text-center padding-top-05rem">Alternatively, use username and email:</p>
          <div className="label-input-container">
            <label className="form-label" htmlFor="username">
              Username:
              <FontAwesomeIcon icon={faSquareCheck} className={validUsername ? "valid" : "hide"} />
              <FontAwesomeIcon icon={faSquareXmark} className={validUsername || !username ? "hide" : "invalid"} />
            </label>
            <input
              className="form-text"
              type="text"
            ...
            <div
              id="uidnote"
              className={usernameFocus && username && !validUsername ? "instructions-container" : "offscreen"}
            >
          ...
          <div className="label-input-container">
            ...
            />
            <div id="pwdnote" className={passwordFocus && !validPassword ? "instructions-container" : "offscreen"}>
              <div className="instructions-icon-container">
                <FontAwesomeIcon icon={faInfoCircle} />
          ...
          <div className="label-input-container">
            ...
            />
            <div
              id="confirmnote" className={passwordMatchFocus && !validPasswordMatch ? "instructions-container" : "offscreen"}
            >
              <div className="instructions-icon-container">
                <FontAwesomeIcon icon={faInfoCircle} />
                <p>Must match</p>
          ...
          <button disabled={!validUsername || !validPassword || !validEmail || !validPasswordMatch ? true : false}>
            Sign Up
          </button>
