...
export async function GET(req: NextRequest) {
  ...
  const steamVerifyUrl = process.env.NODE_ENV === "production" ? process.env.STEAM_VERIFY_URL_production : process.env.STEAM_VERIFY_URL_development;
  const relyingParty = new openid.RelyingParty(steamVerifyUrl as string, hostUrl as string,true,true,[]);
