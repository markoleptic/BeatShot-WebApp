        ...
        <div className="hero-container">
          <div className="hero">
            ...
            <p className="hero-lead">
              How are spawn locations decided for targets? How are targets managed? This article goes into detail about
              how this is accomplished in Unreal.
            </p>
        ...
        <div className="flex-container-row">
          ...
          <article className="flex-container-column" id="article">
            <p className="margin-bottom-05rem">
              I wrote this article with the goal that the reader doesn&#39;t need to understand C++ to grasp the main
              concepts that BeatShot uses in its target spawning system. The code blocks are supplementary and I follow
              a general pattern when inserting them: introduce the function and context, insert code block, describe
              what&#39;s happening in the code block.
            </p>
            <div className="article-section" ref={Ref_Classes} id="classes-header">
              ...
              <div className="article-subsection" ref={Ref_USpawnArea} id="classes-USpawnArea">
                ...
                <div>
                  <p>
                    ...
                    <em>total spawn area</em>. The total spawn area dimensions are the Horizontal and Vertical Spread
                    from custom game mode options. These dimensions correspond to the actual size in Unreal units, and
                    when maxed out represent 3.2 million individual points.
                  </p>
                  <p>
              ...
              <div className="article-subsection" ref={Ref_ATargetManager} id="classes-ATargetManager">
                ...
                <p className="margin-bottom-05rem">
                  ...
                  handles all <em>Target Activation Responses</em>, which are used to describe what a target does when
                  it is activated. Some examples include removing immunity and changing the direction of a moving
                  target. This actor relies on several important components that distribe its functionality.
                </p>
              ...
              <div className="article-subsection" ref={Ref_ATarget} id="classes-ATarget">
                ...
                <p>
                  ...
                  addition to deactivation, the target is also responsible for its own destruction, which is triggered
                  by a <em>Target Destruction Condition</em>. Deactivation and Destruction are discussed more in their
                  respective sections.
                </p>
                <p className="margin-bottom-05rem">
                ...
                <div ref={Ref_UProjectileMovementComponent} id="classes-UProjectileMovementComponent">
                  ...
                  <div>
                    <p>
                      ...
                      <BSInlineFunction className={"ATarget"} functionName={"SetTargetDirection"} /> when it wants to
                      change the velocity or direction. These also happen to be Target Activation Responses.
                    </p>
                    <p>
                ...
                <div ref={Ref_UBSAbilitySystemComponent} id="classes-UBSAbilitySystemComponent">
                  ...
                  <div>
                    ...
                    <p>
                      The ASC enables us to apply immunity to the target for the different damage types (and control
                      them independently) and has built in support for tracking attributes like health.
                    </p>
                    <p>
                ...
                <div ref={Ref_UBSHealthComponent} id="classes-UBSHealthComponent">
                  ...
                  <div>
                    <p>
                      The health component is initialized with ability system component so that it can listen for
                      changes to the health attribute of the target. The target binds the health component&#39;s
                      OnHealthChanged delegate to its{" "}
                      <BSInlineFunction className={"ATarget"} functionName={"OnHealthChanged"} /> function. If you
                      aren&#39;t familiar with delegates, this just means that when the target health changes, the function
                      will be called.
                    </p>
                    <ul>
                      In this case, the OnHealthChanged delegate has three parameters that will be passed to the
                      function:
                      <li>
                        <FontAwesomeIcon icon={faCrosshairs} className="li-icon" />
            ...
            <div className="article-section" ref={Ref_TargetLifeCycle} id="target-lifecycle">
              ...
              <p className="margin-bottom-05rem">
                Every target goes through the same lifecycle of spawning, activation, deactivation, and destruction.
                Before discussing those events, I&#39;ll describe the initialization process that the involved actors go
                through.
              </p>
              <div className="article-subsection" ref={Ref_Initialization} id="target-lifecycle-Initialization">
                ...
                <div>
                  <p>
                    ...
                    inside <BSInlineFunction className={"ATargetManager"} functionName={"Init"} />. More specifically,
                  ...
                  <p>
                    ...
                    <BSInlineFunction className={"USpawnAreaManagerComponent"} functionName={"InitializeSpawnAreas"} />{" "}
                    is called to generate all SpawnAreas for the game mode. This is where the SpawnArea Manager
                    Component determines how many SpawnAreas the total spawn area needs to be divided into. This happens
                    inside{" "}
                    <BSInlineFunction className={"USpawnAreaManagerComponent"} functionName={"SetSpawnMemoryValues"} />.
                    Once the width and height of the SpawnAreas are found, the SpawnArea Manager Component creates a new
                    USpawnArea object for each section of the total spawn area. It then calls{" "}
                    <BSInlineFunction className={"USpawnArea"} functionName={"Init"} />, which sets up basic information
                    about the SpawnArea. Notably, it also specifies which type of section inside the total spawn area it
              ...
              <div className="article-subsection" ref={Ref_Spawning} id="target-lifecycle-Spawning">
                ...
                <div>
                  ...
                  <p>
                    Game modes using <BSInlineEnum className={"ETargetSpawningPolicy"} valueName={"UpfrontOnly"} />{" "}
                    spawn all targets inside <BSInlineFunction className={"ATargetManager"} functionName={"Init"} />. No
                    other targets are spawned for the duration of the game mode.
                  </p>
                  <p>
                    Game modes using <BSInlineEnum className={"ETargetSpawningPolicy"} valueName={"RuntimeOnly"} />{" "}
                    spawn their targets based on beat thresholds being met by the audio analyzer, which triggers the
                    game mode to call{" "}
                    <BSInlineFunction className={"ATargetManager"} functionName={"OnAudioAnalyzerBeat"} />. I discuss
                    this function more in the Activation section, but for now I want to focus on what happens when any
                  ...
                  <p>
                    ...
                    SpawnActorDeferred so the game mode config can be passed to the target before it&#39;s finished
                    spawning.
                  </p>
                  <p>
                    <BSInlineFunction className={"ATarget"} functionName={"Init"} /> sets the Max Health attribute of
                    the target and provides all the information the target needs about the game mode. The Target Manager
                    binds to the target&#39;s OnTargetDamageEventOrTimeout delegate, which is broadcast when the health of
                    the target is changed. This delegate is discussed more in the Deactivation section.
                  </p>
                  <p>
                    ...
                    />{" "}
                    is called. This lets the Spawn Area Manager know that the SpawnArea now represents a target.
                  </p>
                  <p>
                    When a SpawnArea is flagged as <em>Managed</em>,{" "}
                    <BSInlineFunction className={"USpawnArea"} functionName={"GenerateOverlappingVertices"} /> is
                    called. This function finds all surrounding SpawnAreas that would cause an overlap if a target with
                  ...
                  <p>
                    ...
                    points mean it&#39;s not. Each time a new target occupies a given SpawnArea, these vertices generated
                    and stored. They are then used when finding subsequent target spawn locations, which is discussed in
                    the Activation section.
                  </p>
                  <p>
                    The radius of the traced sphere should be big enough that it captures all SpawnAreas that would
                    cause an overlap, but small enough that it doesn&#39;t restrict the possible spawn locations to an
                    unnecessary small amount. Since a target can spawn anywhere inside a SpawnArea, some amount of error
                    is introduced.
                  </p>
                  <p>
              ...
              <div className="article-subsection" ref={Ref_Activation} id="target-lifecycle-Activation">
                ...
                <div>
                  <p>
                    ...
                    <BSInlineFunction className={"ATargetManager"} functionName={"OnAudioAnalyzerBeat"} />. If using a
                    song from a file, this would occur exactly Spawn Beat Delay seconds before you actually hear the
                    beat.
                  </p>
                  ...
                  <p>
                    ...
                    according to the game mode config using{" "}
                    <BSInlineFunction className={"ATargetManager"} functionName={"HandleActivateExistingTargets"} />.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    <BSInlineFunction className={"ATargetManager"} functionName={"FindNextTargetProperties"} />, and
                  ...
                  <p>
                    <BSInlineFunction className={"ATargetManager"} functionName={"GetNextTargetScale"} /> returns either
                    a random target scale between the Min and Max Target Scale or a dynamic target scale taken from a
                    curve based on the number of recent targets successfully destroyed.
                  </p>
                  <p>
                    The SpawnArea containing the next target location is found using{" "}
                    <BSInlineFunction className={"ATargetManager"} functionName={"GetNextSpawnArea"} />, which goes
                    through several checks to see if it can spawn at the origin or get a SpawnArea from the RL
                    Component, but the main thing I want to focus on is when it calls{" "}
                    <BSInlineFunction
                      className={"USpawnAreaManagerComponent"}
                  ...
                  <p>
                    ...
                    Most distribution policies begin considering all SpawnAreas as valid choices, rather than only
                    finding SpawnAreas that aren&#39;t currently activated or recent. This is because a smaller target may
                    spawn before a larger target, and the cutout size of the sphere it left will not be big enough to
                    safely spawn the next larger target without overlapping the smaller one. This is also why the target
                    scale is found before finding the SpawnArea.
                  </p>
                  <p>
                    <BSInlineFunction
                      className={"USpawnAreaManagerComponent"}
                    ...
                    modes using <BSInlineEnum className={"EBoundsScalingPolicy"} valueName={"Dynamic"} /> since the
                    total spawn area is always the same for game modes using{" "}
                    <BSInlineEnum className={"EBoundsScalingPolicy"} valueName={"Static"} />. Referring to Figure 3, the
                    red boxes outside the the current spawn area (blue box) are the SpawnAreas this function removed
                    from consideration for a game mode using{" "}
                  ...
                  <figure>
                    <div className="figure-border-container">
                      ...
                      <figcaption>
                        ...
                        <BSInlineEnum className={"EBoundsScalingPolicy"} valueName={"Dynamic"} />, where green boxes
                        represent valid and red boxes represent invalid. The blue box represents the current total spawn
                        area.
                      </figcaption>
                    </div>
                  </figure>
                  ...
                  <p>
                    The overlapping vertices that are added are the same overlapping vertices that were generated when
                    the target was spawned. If the scale for the target to be spawned is greater than the scale that the
                    overlapping points were generated with, a temporary set is generated using the larger radius.
                  </p>
                  <p>
                    As soon as the target is activated by the Target Manager, the timelines that control the color
                    and/or scale of the target begin playing and a timer is set for the duration of its Max Lifespan. If
                    the timer is allowed to expire, the target damages itself using a{" "}
              ...
              <div className="article-subsection" ref={Ref_Deactivation} id="target-lifecycle-Deactivation">
                ...
                <div>
                  ...
                  <ul>
                    ...
                    <li>
                      <FontAwesomeIcon icon={faCrosshairs} className="li-icon" />
                      How far into the target&#39;s Max Lifespawn the target was destroyed. The value will be -1 if the
                      target expired. This is mostly used for scoring
                    </li>
                    <li>
                      <FontAwesomeIcon icon={faCrosshairs} className="li-icon" />
                  ...
                  <p>
                    <BSInlineFunction className={"ATargetManager"} functionName={"OnTargetHealthChangedOrExpired"} /> is
                    the function that all targets broadcast the delegate to.
                  </p>
                  <p>
                    ...
                    <BSInlineEnum className={"EConsecutiveTargetScalePolicy"} valueName={"SkillBased"} /> and the total
                    spawn area if using <BSInlineEnum className={"EBoundsScalingPolicy"} valueName={"Dynamic"} />. The
                    struct is then forwarded to the game mode which updates the score and player HUD. The target is
                    removed from the Target Manager&#39;s managed target array if the Target Destruction Conditions permit.
                    Any time a target is removed from this array,{" "}
                    <BSInlineFunction
                      className={"USpawnAreaManagerComponent"}
                  ...
                  <p>
                    Next, if the game mode uses the RL Component, the reward for the previous-current target location
                    pair is updated.
                  </p>
                  <p>
                    Then,{" "}
                    ...
                    />{" "}
                    is called. This function removes the Activated flag from the SpawnArea and flags it as Recent. A
                    timer is set based on the <em>Recent Target Memory Policy</em> and the Recent flag is then removed
                    when the timer expires. Upon removal of the Recent flag, the overlapping vertices that were
                    generated when the target was spawned are emptied.
                  </p>
                  <p>
                    If the game mode uses a Recent Target Memory Policy that keeps the footprint of recent targets too
                    long, targets won&#39;t have anywhere to be spawned. Figure 4 shows what it looks like moments before
                    disaster (not really, the game simply won&#39;t spawn a target until there&#39;s space).
                  </p>
                  <figure>
                    <div className="figure-border-container">
              ...
              <div className="article-subsection" ref={Ref_Destruction} id="target-lifecycle-Destruction">
                ...
                <div>
                  <p>
                    ...
                    Since the target broadcast the delegate before checking the Destruction Conditions, the Target
                    Manager will have already removed it from its managed target array before the target destroys
                    itself.
                  </p>
                  <ol>
              ...
              <div className="article-subsection">
                ...
                <p className="inline updated-date">
                  <span className="inline text-light">Updated:</span> July 9, 2023
                </p>
              </div>
            </div>
          </article>
